...
const Test = ({testProduct}) => {
    console.log("testProduct", testProduct.test_product)
    ...
    const handleClick = () => {
        dispatch(addProduct({product:testProduct.test_product, price:testProduct.test_product.price, quantity:quantity}))
                ...
                <div className='flex flex-col md:flex-row'>
                    ...
                    <div className='flex flex-col md:ml-6 '>
                        <div className='lg:max-w-[60%] text-center md:text-start'>
                            <h3 className='font-semibold text-3xl mb-2'>{testProduct.test_product.name}</h3>
                            ...
                            <div className='flex flex-row items-start justify-center md:justify-start mb-6'>
                                ...
                                <h2 className='text-xl text-[#5BDADD] ml-4'> KES {testProduct.test_product.price} </h2>
                            </div>
