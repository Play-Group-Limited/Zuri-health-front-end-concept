            ...
            <div className='flex flex-col md:flex-row'>
                ...
                <div className='flex flex-col md:ml-6 w-full md:max-w-[50%]'>
                    <div className='md:max-w-[40%] text-center md:text-start'>
                        <h3 className='font-semibold text-3xl mb-2'>Zincovit Tablet 15's</h3>
                    ...
                    <div className='flex flex-col max-w-[70%]'>
                        ...
                        <p>
                            Zincovit Tablet is a nutritional supplement with vitamins A, B 
                            <br />
                            complex, C, D, and E and minerals such as Magnesium, Manganese, 
                            Iodine, Copper, Selenium, Chromium, Zinc, and Grape seed extracts.
                            It helps combat deficiency of vitamins and minerals and helps 
