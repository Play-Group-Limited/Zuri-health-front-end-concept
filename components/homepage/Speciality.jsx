            ...
            <div className='bg-[#5BDADD] w-full h-full  p-4 pt-8 md:p-12 md:rounded-3xl border border-blue-400  '>
                <div className='flex flex-col md:flex-row justify-evenly w-full'>
                    <div className='flex flex-col items-center md:items-start justify-center'>
                        <h3 className='text-3xl font-bold text-center'>Explore by Speciality</h3>
                        <p className=''>Find experienced doctors accross all specialities</p>
                        <p className='mx-2 underline text-center md:hidden pt-6'>View All</p>
                    </div>
                    ...
                    <div className='flex flex-col md:flex-row md:justify-between'>
                        ...
                        <div className='h-[100%] flex flex-col justify-center items-center'>
                            <p className='mx-2 underline text-center hidden md:block '>View All</p>
                        </div>
                    </div>
